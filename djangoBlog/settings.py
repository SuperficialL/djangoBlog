...
if socket.gethostbyname(socket.gethostname())[:3] == '192':
    DEBUG = True
    ALLOWED_HOSTS = ['127.0.0.1', '192.168.72.129']
else:
    DEBUG = False
    ALLOWED_HOSTS = ['www.zhangwurui.com', 'zhangwurui.com', '127.0.0.1', '192.168.72.129']
...
ADMINS = [('Superficial', '15871930413@163.com'), ('Superficial', '347106739@QQ.com')]
...
LOGGING = {
    ...
    'handlers': {
        ...
        'error': {
            ...
            # 保存到文件，自动切
            'filename': '%s/djangoBlog_err.log' % LOG_PATH,
            # 日志文件
